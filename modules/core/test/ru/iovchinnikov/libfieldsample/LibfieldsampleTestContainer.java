package ru.iovchinnikov.libfieldsample;
...
public class LibfieldsampleTestContainer extends TestContainer {

    public LibfieldsampleTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/iovchinnikov/libfieldsample/app.properties",
    ...
    public static class Common extends LibfieldsampleTestContainer {

        public static final LibfieldsampleTestContainer.Common INSTANCE = new LibfieldsampleTestContainer.Common();
